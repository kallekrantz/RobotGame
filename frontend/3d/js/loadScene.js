require([
	...
	function init() {
		...
		var robotPos = new Vector3(parent.currentMatchState.robots[0].getX(), 0, parent.currentMatchState.robots[0].getZ());
					 ...
					 run: function (entity) {
						var currentT = (new Date).getTime();
						 ...
						 T = currentT;
						  for( var i=0;i<2;i++){
							// console.log("en");
							parent.currentMatchState.robots[0].setdX(parent.nextMatchState.robots[0].getdX());
							parent.currentMatchState.robots[0].setdZ(parent.nextMatchState.robots[0].getdZ());
							parent.currentMatchState.robots[0].setAngularVelocity(parent.nextMatchState.robots[0].getAngularVelocity());
							parent.currentMatchState.robots[0].setX(parent.currentMatchState.robots[0].getX()+dT*parent.currentMatchState.robots[0].getdX());
							parent.currentMatchState.robots[0].setZ(parent.currentMatchState.robots[0].getZ()+dT*parent.currentMatchState.robots[0].getdZ());
							parent.currentMatchState.robots[0].setRotation(parent.currentMatchState.robots[0].getRotation()*dT*parent.currentMatchState.robots[0].getAngularVelocity());
							entity.transformComponent.setTranslation(parent.currentMatchState.robots[0].getX(),parent.currentMatchState.robots[0].getY(),parent.currentMatchState.robots[0].getZ());
							entity.transformComponent.setRotation(0,parent.currentMatchState.robots[0].getRotation(),0);
